...
data = {
    ...
    "Age": [25, 45, 60, 35, 50, 42, 38, 55, 65, 70, 48, 33, 28, 75, 90],
    "Blood_Pressure": [120, 135, 180, 128, 140, 130, 125, 145, 190, 135, 138, 126, 124, 200, 250],
    "Sugar_Level": [90, 110, 180, 95, 130, 120, 100, 140, 250, 115, 118, 105, 98, 260, 400],
    "Heart_Rate": [72, 80, 95, 75, 82, 78, 74, 85, 100, 76, 79, 73, 71, 105, 140]
}
...
for col in medical_columns:
    ...
    sns.histplot(df[col], bins=8, kde=True, color="skyblue")
